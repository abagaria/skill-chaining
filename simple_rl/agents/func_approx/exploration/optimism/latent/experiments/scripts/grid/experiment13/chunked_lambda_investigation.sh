...
python -u $path_to_function --experiment_name="writes/exp13-mcar-grid" --run_title $run_title --seed $seed --steps $num_steps --lam $lambda --optimization_quantity chunked-bonus --bonus_scaling_term none --epochs $epochs --env_name "MountainCar-v0" --pixel_observation --lam_scaling_term none
