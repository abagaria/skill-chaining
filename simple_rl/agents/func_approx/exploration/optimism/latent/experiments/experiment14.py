...
class Experiment14:
    ...
    def __init__(self, seed, *, chunk_size, pixel_observation, num_steps, device, experiment_name):
        self.mdp = GymMDP(env_name="MountainCar-v0", pixel_observation=pixel_observation, seed=seed, control_problem=True)
...
if __name__ == "__main__":
    ...
    exp = Experiment14(args.seed, num_steps=args.steps, device=device, chunk_size=args.chunk_size,
                       experiment_name=full_experiment_name, pixel_observation=args.pixel_observation)
