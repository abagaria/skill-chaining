...
class DDPGAgent(Agent):
    ...
    def __getstate__(self):
        excluded_keys = ("actor", "actor_optimizer", "critic", "critic_optimizer", "target_actor", "target_critic")
        state_dictionary = {x: self.__dict__[x] for x in self.__dict__ if x not in excluded_keys}
        state_dictionary["actor_state"] = self.actor.state_dict()
        state_dictionary["actor_optimizer"] = self.actor_optimizer.state_dict()
        state_dictionary["critic_state"] = self.critic.state_dict()
        state_dictionary["critic_optimizer"] = self.critic_optimizer.state_dict()
        state_dictionary["target_actor_state"] = self.target_actor.state_dict()
        state_dictionary["target_critic_state"] = self.target_critic.state_dict()
