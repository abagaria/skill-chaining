...
class CoveringOptions(Option):
    ...
    def __init__(self, replay_buffer, obs_dim, overall_mdp, global_solver, lr_actor, lr_critic, ddpg_batch_size,
                 feature=None, threshold=0.95, num_units=200, num_training_steps=1000, actor_learning_rate=0.0001,
                 critic_learning_rate=0.0001, batch_size=64, option_idx=None, name="covering-options"):
        super().__init__(overall_mdp, name, global_solver, lr_actor, lr_critic, ddpg_batch_size, option_idx)
        ...
        # SkillChainingClass expects these attributes from all Options
        self.children = []
