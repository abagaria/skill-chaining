...
class KiranPlotterUtil(object):
    ...
    def visualize_ddpg_replay_buffer(self, solver, solver_number, directory):
        print('*' * 80)
    ...
    def visualize_gc_ddpg_replay_buffer(self, solver, goal_state, solver_number, directory):
        print('*' * 80)
        print("Plotting value function...")
        print('*' * 80)
