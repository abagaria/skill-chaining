...
class FourRoomMDP(GridWorldMDP):
    ...
    def __init__(self, width=9, height=9, init_loc=(1,1), goal_locs=[(9,9)], gamma=0.99, slip_prob=0.00, name="four_room",
                 is_goal_terminal=True, rand_init=False, step_cost=0.0):
        '''
        Args:
            height (int)
            width (int)
        ...
        '''
        GridWorldMDP.__init__(self, width, height, init_loc, goal_locs=goal_locs, walls=self._compute_walls(width, height),
                              gamma=gamma, slip_prob=slip_prob, name=name, is_goal_terminal=is_goal_terminal,
