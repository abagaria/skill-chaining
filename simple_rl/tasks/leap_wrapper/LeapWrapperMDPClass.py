...
class LeapWrapperMDP(GoalDirectedMDP):
    ...
    def __init__(self, dense_reward=False, render=False):
        ...
        puck_goal_1, puck_goal_2, puck_goal_3 = [-0.05, 0.6], [-0.09, 0.6], [-0.13, 0.6]
        ...
        salient_events = [
            BaseSalientEvent(salient_event_1, 1, name='Puck to goal 1/3', get_relevant_position=get_puck_pos),
            BaseSalientEvent(salient_event_2, 2, name='Puck to goal 2/3', get_relevant_position=get_puck_pos),
            BaseSalientEvent(salient_event_3, 3, name='Puck to goal 3/3', get_relevant_position=get_puck_pos)
        ]
    ...
    def _reward_func(self, state, action):
        ...
        assert(all(self.env._get_obs()['observation'] == state.position) and all(state.position == self.cur_state.position))
